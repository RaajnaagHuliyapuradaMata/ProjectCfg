...
#include "infEcuabIfMem.hpp"
#include "EcuabFee.hpp"

#if((MEMIF_CFG_MAJOR_VERSION != (5u)) || (MEMIF_CFG_MINOR_VERSION != (2u)))
#error "Version numbers of CfgEcuabIfMem.c and CfgEcuabIfMem.hpp are inconsistent!"
#endif

#if((MEMIF_SW_MAJOR_VERSION != (3u)) || (MEMIF_SW_MINOR_VERSION != (3u)))
#error "Version numbers of CfgEcuabIfMem.c and infEcuabIfMem.hpp are inconsistent!"
#endif
