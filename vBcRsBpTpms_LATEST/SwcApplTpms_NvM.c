...
static uintptr ui32GetMemberStartByte(uint8 ui8Cat, uint8 ui8Member){
  ...
  case 1:
      switch(ui8Member){
         case 1:  p2Member = (const uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx01_WsIdWN;              break;
         case 2:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx02_CdIdWN;              break;
         case 3:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx03_WdIdWN;              break;
         case 4:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx04_TsIdTM;              break;
         case 5:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx05_CbIdTM;              break;
         case 6:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx06_WarnTypeArrayIdWN;   break;
         case 7:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx07_ucResetWarnPressRef; break;
         case 8:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx08_ucPatmo;             break;
         case 9:  p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.scIdx09_scAdaptedTref;       break;
         case 10: p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx10_Unused;              break;
         default: p2Member = (      uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx01_WsIdWN;              break;
      }
      break;
  case 2:
      switch(ui8Member){
         case 1:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData .ucIdx01_ucReErrorStatuse;     break;
         case 2:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx02_ucReHeatUpStatuse;     break;
         case 3:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx03_ucFolgeAusfallCnt;     break;
         case 4:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx04_uiGutEmpfCnt;          break;
         case 5:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx05_uiMissedCnt;           break;
         case 6:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx06_bRadwechsel;           break;
         case 7:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx07_bHfIntLatch;           break;
         case 8:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx08_ucStatusEOLRoutine;    break;
         case 9:  p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx09_ucIsEOLRoutineActive;  break;
         case 10: p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx10_DTCActiveStatus;       break;
         case 11: p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx11_DTCSingleActiveStatus; break;
         case 12: p2Member = (uint8*) p2Mir->tStrAcc.tCat02.sData.ucIdx12_Unused;                break;
         default: p2Member = (uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx01_WsIdWN;                break;
      }
      break;
  case 3:
      switch(ui8Member){
         case 1:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx01_HistoryID;                      break;
         case 2:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx02_HistoryWP;                      break;
         case 3:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx03_WA_Parameter;                   break;
         case 4:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx04_WA_ABSTicksInOneRev;            break;
         case 5:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx05_ucVarAutolocationFailedCounter; break;
         case 6:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx06_Unused;                         break;
         case 7:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx07_Unused;                         break;
         case 8:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx08_Unused;                         break;
         case 9:  p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx09_Test;                           break;
         case 10: p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx10_Test;                           break;
         case 11: p2Member = (uint8*) p2Mir->tStrAcc.tCat03.sData.ucIdx11_Test;                           break;
         default: p2Member = (uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx01_WsIdWN;                         break;
      }
      break;
  case 4:
      switch(ui8Member){
         case 1:  p2Member = (uint8*) p2Mir->tStrAcc.tCat04.sData.ucIdx01_CcpCrcFilter;   break;
         case 2:  p2Member = (uint8*) p2Mir->tStrAcc.tCat04.sData.ucIdx02_CcpIdFilter;    break;
         case 3:  p2Member = (uint8*) p2Mir->tStrAcc.tCat04.sData.ucIdx03_CcpAnzIdFilter; break;
         case 4:  p2Member = (uint8*) p2Mir->tStrAcc.tCat04.sData.ucIdx04_CcpOnOff;       break;
         case 5:  p2Member = (uint8*) p2Mir->tStrAcc.tCat04.sData.ucIdx05_CcpFilterIds;   break;
         default: p2Member = (uint8*) p2Mir->tStrAcc.tCat01.sData.ucIdx01_WsIdWN;         break;
      }
      break;
  case 5:
...
static void InitEECat06(void){
   ...
   tTmpCat6.sData.scIdx05_TemperatureFL[0] = -1;
   tTmpCat6.sData.scIdx06_TemperatureFR[0] = -1;
   tTmpCat6.sData.scIdx07_TemperatureRL[0] = -1;
   tTmpCat6.sData.scIdx08_TemperatureRR[0] = -1;
