...
extern FUNC(Std_ReturnType, DCM_APPL_CODE) DcmDsp_RequestResultVehicleEolTestProcedure_Callback(
   ...
   *ErrorCode = HufIf_DiagReqCallback(E_TPMS_DIAG_RESULT_TPMS_EOL, &S_DiagData);
   UNUSED(OpStatus);
   if((DCM_E_OK == *ErrorCode) && (5 == *S_DiagData.puiResDataLen)){
...
FUNC(Std_ReturnType, DCM_APPL_CODE) SecaFBL_GetSeed(
   ...
   do{
      ...
      ucAttempts--;
         ...
         (DCM_E_SEED_NOK == DcmAppl_DcmCheckSeed(Seedlen_u32, Seed))
      && (ucAttempts > 0)
   );
  *ErrorCode = DcmAppl_DcmCheckSeed(Seedlen_u32, Seed);
   if(DCM_E_OK == *ErrorCode){
      ComputeKeyFromSeed(
            SECA_LEVEL_PROGRAMMING
         ,  Seed
         ,  (uint16)Seedlen_u32
         ,  aucSecurityKeyReprogramming
         ,  ushSizeOfKey
         ,  &ushSizeOfKey
      );
      tRetVal = DCM_E_OK;
   ...
   UNUSED(SecLevel_u8);
   UNUSED(AccDataRecsize_u32);
   UNUSED(SecurityAccessDataRecord);
   UNUSED(OpStatus);
   return tRetVal;
}

FUNC(Std_ReturnType, DCM_APPL_CODE) SecaDATA_GetSeed(
        VAR(Dcm_SecLevelType,             AUTOMATIC                 ) SecLevel_u8
   ,    VAR(uint32,                       AUTOMATIC                 ) Seedlen_u32
   ,    VAR(uint32,                       AUTOMATIC                 ) AccDataRecsize_u32
   ,  P2VAR(uint8,                        AUTOMATIC, DCM_INTERN_DATA) SecurityAccessDataRecord
  ...
  *ErrorCode = DcmAppl_DcmCheckSeed(Seedlen_u32, Seed);
   if(DCM_E_OK == *ErrorCode){
      ComputeKeyFromSeed(
            SECA_LEVEL_APPLICATION
         ,  Seed
         ,  (uint16)Seedlen_u32
         ,  aucSecurityKeyApplication
         ,  ushSizeOfKey
         ,  &ushSizeOfKey
      );
      tRetVal = DCM_E_OK;
...
FUNC(Std_ReturnType, DCM_APPL_CODE) SecaFBL_CompareKey(
        VAR(uint32,                       AUTOMATIC                  ) KeyLen_32
...
FUNC(Std_ReturnType, DCM_APPL_CODE) SecaDATA_CompareKey(
        VAR(uint32,                       AUTOMATIC                  ) KeyLen_32
   ,  P2VAR(uint8,                        AUTOMATIC, DCM_INTERN_CONST) Key
   ,    VAR(Dcm_OpStatusType,             AUTOMATIC                  ) OpStatus
   ,  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA ) ErrorCode
...
static void ComputeKeyFromSeed(
      uint8   ucSecaLevel
   ,  uint8*  seed
   ,  uint16  sizeSeed
   ,  uint8*  key
   ...
   if(SECA_LEVEL_APPLICATION == ucSecaLevel){
...
FUNC(Std_ReturnType, DCM_APPL_CODE) Fbl_ProgM_EraseMemoryCallback_65280(
   ...
   UNUSED(dataIn1);
   UNUSED(OpStatus);
   UNUSED(CurrentDataLength);
   UNUSED(ErrorCode);
   return E_OK;
}

FUNC(Std_ReturnType, DCM_APPL_CODE) Fbl_ProgM_VerifyDownloadCallback(
        VAR(Dcm_OpStatusType,             AUTOMATIC               ) OpStatus
   ,  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_APPL_DATA) ErrorCode
){
   UNUSED(OpStatus);
...
FUNC(Std_ReturnType, DCM_APPL_CODE) Fbl_Port_DisableRxAndTx(
...
Std_ReturnType DCM_CheckSecurityLevelForReadDids(
...
static boolean DCM_IsMemoryInitialized(
      uint8* ucBuffer
   ,  uint8  ucLength
){
...
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadApplicationId_UserSpecificCheck                 (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadAppSwFingerprint_UserSpecificCheck              (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadApplicationProgramInformation_UserSpecificCheck (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadBootloaderId_UserSpecificCheck                  (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadBootSwFingerprint_UserSpecificCheck             (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadBootloaderProgramInformation_UserSpecificCheck  (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadComponentAndSwType_UserSpecificCheck            (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadAuxId_UserSpecificCheck                         (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadModeId_UserSpecificCheck                        (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadGenealogyVersionNumber_UserSpecificCheck        (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadGenealogyCrc32_UserSpecificCheck                (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadFullGenealogyBlock_UserSpecificCheck            (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadApplicationSignature_UserSpecificCheck          (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadEcuSerialNumber_UserSpecificCheck               (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadBoardSerialNumber_UserSpecificCheck             (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadEcuPartNumber_UserSpecificCheck                 (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadBoardPartNumber_UserSpecificCheck               (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ReadActiveSessionIndicator_UserSpecificCheck        (P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8, VAR(uint16, AUTOMATIC) did_u16, VAR(Dcm_Direction_t, AUTOMATIC) dataDirection_en){UNUSED(did_u16); return DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);}
...
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_Vin_UserSpecificCheck(
   ...
   Std_ReturnType result = DCM_CheckSecurityLevelForReadDids(Nrc_u8, dataDirection_en);
   if(E_OK == result){
      ucSize = PRODFLASH_GetVin(ucBuffer);
      bIsInitialized = DCM_IsMemoryInitialized(ucBuffer, ucSize);
      if(
            ((DCM_SUPPORT_READ  == dataDirection_en) && (TRUE  == bIsInitialized))
         || ((DCM_SUPPORT_WRITE == dataDirection_en) && (FALSE == bIsInitialized))
      ){
         result = E_NOT_OK;
...
FUNC(Std_ReturnType, DCM_APPL_CODE) Dcm_ManufacturingSupportMode_UserSpecificCheck(
      P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_INTERN_DATA) Nrc_u8
   ,    VAR(uint16,                       AUTOMATIC                 ) did_u16
   ,    VAR(Dcm_Direction_t,              AUTOMATIC                 ) dataDirection_en
){
   Std_ReturnType result;
   if(DCM_SUPPORT_WRITE == dataDirection_en){
      result = E_NOT_OK;
